<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<OlympOnline.Models.EmailConfirmationModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <% if (Model.RegStatus == OlympOnline.Models.EmailConfirmationStatus.Confirmed)
   { %>
<h3>
...
<% }
       else if (Model.RegStatus == OlympOnline.Models.EmailConfirmationStatus.WrongTicket)
   { %>
    <h3> <%= GetGlobalResourceObject("EmailConfirmation", "WrongTicket").ToString()%> </h3>
<% }
       else if (Model.RegStatus == OlympOnline.Models.EmailConfirmationStatus.WrongEmail)
   { %>
    <h3><%= GetGlobalResourceObject("EmailConfirmation", "WrongEmail").ToString()%></h3>
<% }
       else if (Model.RegStatus == OlympOnline.Models.EmailConfirmationStatus.FirstEmailSent)
   { %>
