<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Applicant/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OlympOnline.Models.AppendFilesModel>" %>
...
<p class="message info">
    <asp:Literal runat="server" Text="<%$ Resources:AddSharedFiles, HelpMessage %>"></asp:Literal>
</p>
   ...
   { %>
        <tr id="<%= file.Id.ToString() %>">
            ...
            <td style="vertical-align:middle; text-align:center;">
                <span style="font-weight:bold" <%= file.IsApproved == OlympOnline.Models.ApprovalStatus.Approved ? "class=\"Green\"" : file.IsApproved == OlympOnline.Models.ApprovalStatus.Rejected ? "class=\"Red\"" : "class=\"Blue\"" %>>
                <%= file.IsApproved == OlympOnline.Models.ApprovalStatus.Approved ?
                       GetGlobalResourceObject("AddSharedFiles", "ApprovalStatus_Approved") :
                              file.IsApproved == OlympOnline.Models.ApprovalStatus.Rejected ? 
